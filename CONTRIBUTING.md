...
We welcome all contributions to atomicstrain-kit!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/bylehn/atomicstrain_kit/issues)
...
The second two options both involve making a [pull request](https://github.com/bylehn/atomicstrain_kit/pulls) .
