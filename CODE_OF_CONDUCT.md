...
The atomicstrain-kit *Code of Conduct* sets the rules for the behavior of
every member in the atomicstrain-kit community so that everyone can
...
atomicstrain-kit is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make atomicstrain-kit a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and atomicstrain-kit is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of atomicstrain-kit comes from its varied community
...
reported by contacting the project team at 'f.bylehn@gmail.com'. The project team will
